...
void setup_scr_screen_user_list(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_user_list_list_1, 0, 16);
    lv_obj_set_size(ui->screen_user_list_list_1, 480, 304);
    ...
    lv_style_set_pad_top(&style_screen_user_list_list_1_main_main_default, 5);
    ...
    lv_style_set_radius(&style_screen_user_list_list_1_main_main_default, 3);
