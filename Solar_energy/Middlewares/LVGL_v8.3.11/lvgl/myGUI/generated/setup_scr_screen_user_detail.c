...
* comply with, be bound by the applicable license terms.  If you do not agree to be bound by the applicable license
...
void setup_scr_screen_user_detail(lv_ui *ui)
{
     ...
     * ============================================================ */
    {
        ...
        lv_label_set_text(title_lbl, "用户详情");
    ...
    lv_obj_set_size(ui->screen_user_detail_label_user, 440, 24);
    lv_obj_align(ui->screen_user_detail_label_user, LV_ALIGN_TOP_MID, 0, 48);
    ...
    lv_table_set_cell_value(ui->screen_user_detail_table_1, 0, 0, "项目");
    ...
    lv_table_set_cell_value(ui->screen_user_detail_table_1, 0, 1, "数值 ");
    lv_table_set_cell_value(ui->screen_user_detail_table_1, 1, 1, "10 kWh ");
    lv_table_set_cell_value(ui->screen_user_detail_table_1, 2, 1, "100 kWh ");
    lv_table_set_cell_value(ui->screen_user_detail_table_1, 3, 1, "1000 kWh ");
    lv_obj_align(ui->screen_user_detail_table_1, LV_ALIGN_TOP_MID, 0, 76);
    ...
    lv_obj_set_style_border_opa(ui->screen_user_detail_table_1, 50, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_user_detail_table_1, 12, LV_PART_ITEMS|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_user_detail_table_1, 12, LV_PART_ITEMS|LV_STATE_DEFAULT);
    ...
    /* 设置列宽 */
    lv_table_set_col_width(ui->screen_user_detail_table_1, 0, 210);
    lv_table_set_col_width(ui->screen_user_detail_table_1, 1, 210);
    ...
    /* 时钟图标 (白色) */
    {
        ...
        lv_obj_set_style_text_color(clock_icon, lv_color_hex(0xffffff), 0);
        lv_obj_set_style_text_font(clock_icon, &lv_font_SourceHanSerifSC_Regular_12, 0);
    ...
    lv_obj_set_pos(ui->screen_user_detail_label_4, 34, 7);
    ...
    lv_label_set_text(ui->screen_user_detail_label_time, "2026年4月23日 13:51:24");
    lv_label_set_long_mode(ui->screen_user_detail_label_time, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_user_detail_label_time, 144, 7);
