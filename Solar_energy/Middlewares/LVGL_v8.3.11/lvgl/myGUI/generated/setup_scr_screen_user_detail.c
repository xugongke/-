...
void setup_scr_screen_user_detail(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_user_detail_label_user, 179, 42);
    lv_obj_set_size(ui->screen_user_detail_label_user, 100, 32);
    ...
    lv_obj_set_pos(ui->screen_user_detail_label_year, 0, 240);
    lv_obj_set_size(ui->screen_user_detail_label_year, 480, 32);
    ...
    lv_obj_set_style_text_align(ui->screen_user_detail_label_year, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_user_detail_label_month, 0, 174);
    lv_obj_set_size(ui->screen_user_detail_label_month, 480, 32);
    ...
    lv_obj_set_style_text_align(ui->screen_user_detail_label_month, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_user_detail_label_day, 0, 108);
    lv_obj_set_size(ui->screen_user_detail_label_day, 480, 32);
    ...
    lv_obj_set_style_text_align(ui->screen_user_detail_label_day, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
