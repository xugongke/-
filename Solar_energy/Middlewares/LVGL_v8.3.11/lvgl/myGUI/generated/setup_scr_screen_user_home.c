...
void setup_scr_screen_user_home(lv_ui *ui)
{
    ...
    lv_obj_set_style_border_opa(ui->screen_user_home_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_user_home_cont_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_user_home_cont_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_user_home_cont_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_user_home_label_Date, 10, 30);
    ...
    lv_obj_set_pos(ui->screen_user_home_label_Time, 18, 10);
    ...
    lv_obj_set_pos(ui->screen_user_home_img_1, 68, 97);
    ...
    lv_obj_set_pos(ui->screen_user_home_cont_2, 346, 0);
    lv_obj_set_size(ui->screen_user_home_cont_2, 134, 62);
    ...
    lv_obj_set_style_border_opa(ui->screen_user_home_cont_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_user_home_cont_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_user_home_cont_2, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_user_home_cont_2, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_user_home_label_2, "光照强度：25");
    lv_label_set_long_mode(ui->screen_user_home_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_user_home_label_2, 10, 30);
    lv_obj_set_size(ui->screen_user_home_label_2, 104, 15);
    ...
    lv_label_set_text(ui->screen_user_home_label_1, "天气：晴");
    lv_label_set_long_mode(ui->screen_user_home_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_user_home_label_1, 18, 10);
    lv_obj_set_size(ui->screen_user_home_label_1, 88, 15);
