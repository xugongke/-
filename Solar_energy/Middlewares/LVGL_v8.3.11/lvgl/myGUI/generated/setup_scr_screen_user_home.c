...
void setup_scr_screen_user_home(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_user_home_user_list_btn, 181, 199);
    ...
    lv_obj_set_pos(ui->screen_user_home_cont_1, 1, 257);
    ...
    lv_obj_set_pos(ui->screen_user_home_img_1, 70, 93);
    ...
    //Write codes screen_user_home_cont_3
    ...
    //Write style for screen_user_home_cont_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_user_home_cont_3, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_user_home_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_user_home_cont_3, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_user_home_cont_3, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_user_home_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_user_home_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_user_home_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_user_home_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_user_home_cont_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_user_home_label_8
    ...
    //Write style for screen_user_home_label_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    ...
    lv_obj_set_style_text_color(ui->screen_user_home_label_8, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_user_home_label_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_user_home_label_ip
    ...
    //Write style for screen_user_home_label_ip, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    ...
    lv_obj_set_style_text_color(ui->screen_user_home_label_ip, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_user_home_label_ip, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_user_home_label_10
    ...
    //Write style for screen_user_home_label_10, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    ...
    lv_obj_set_style_text_color(ui->screen_user_home_label_10, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_user_home_label_10, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_user_home_label_port
    ...
    //Write style for screen_user_home_label_port, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    ...
    lv_obj_set_style_text_color(ui->screen_user_home_label_port, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_letter_space(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_user_home_label_port, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_user_home_bar_1
    ui->screen_user_home_bar_1 = lv_bar_create(ui->screen_user_home);
    lv_obj_set_style_anim_time(ui->screen_user_home_bar_1, 1000, 0);
    lv_bar_set_mode(ui->screen_user_home_bar_1, LV_BAR_MODE_NORMAL);
    lv_bar_set_range(ui->screen_user_home_bar_1, 0, 100);
    lv_bar_set_value(ui->screen_user_home_bar_1, 1, LV_ANIM_OFF);
    lv_obj_set_pos(ui->screen_user_home_bar_1, 9, 11);
    lv_obj_set_size(ui->screen_user_home_bar_1, 56, 16);

    //Write style for screen_user_home_bar_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_user_home_bar_1, 15, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_user_home_bar_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_user_home_bar_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_user_home_bar_1, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_user_home_bar_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write style for screen_user_home_bar_1, Part: LV_PART_INDICATOR, State: LV_STATE_DEFAULT.
    lv_obj_set_style_bg_opa(ui->screen_user_home_bar_1, 255, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_user_home_bar_1, lv_color_hex(0x00ff8c), LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_user_home_bar_1, LV_GRAD_DIR_NONE, LV_PART_INDICATOR|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_user_home_bar_1, 10, LV_PART_INDICATOR|LV_STATE_DEFAULT);
